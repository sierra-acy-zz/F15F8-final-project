...
,p_default_application_id=>99449
...
prompt APPLICATION 99449 - RestfulReL Mobile
--
-- Application Export:
--   Application:     99449
--   Name:            RestfulReL Mobile
--   Date and Time:   07:06 Tuesday November 24, 2015
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,99449)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'F15F8_FINAL_PROJECT')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'RestfulReL Mobile')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_99449')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'3DD5F5688B30333B907ADF842966F0A7A6B31BD1BCAA7A049F8EB8097B7D8CF9'
...
,p_authentication_id=>wwv_flow_api.id(18048012173319786234)
,p_application_tab_set=>0
,p_logo_image=>'TEXT:RestfulReL Mobile'
...
,p_last_upd_yyyymmddhh24miss=>'20151124070335'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(18048003311158786171)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(18048013010719786238)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(18049298157064894334)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(18050400158940961346)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Find a Restaurant'
,p_list_item_link_target=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'3'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(18333696218970760668)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Get Directions'
,p_list_item_link_target=>'f?p=&APP_ID.:9:&SESSION.::&DEBUG.'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'9'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(18335206774950023578)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Restaurant Details'
,p_list_item_link_target=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'10'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(18347693562722557658)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Nutrition Facts'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(18048003086636786170)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(18048003166802786170)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(18048003285357786170)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(18048012058915786232)
,p_icon_sequence=>200
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(18049272176950721794)
,p_lov_name=>'FOOD TYPE'
,p_lov_query=>'MATCH (a:food) RETURN a.food_type'
);
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(18050360237093955187)
,p_lov_name=>'RESTAURANTS'
,p_lov_query=>'MATCH (a:restaurant) RETURN a.name'
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(18048012279141786235)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18048003485924786172)
,p_theme_id=>51
,p_name=>'Dialog'
,p_is_popup=>true
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18048003506547786177)
,p_theme_id=>51
,p_name=>'Page'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18048003636871786177)
,p_page_template_id=>wwv_flow_api.id(18048003506547786177)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18048003784488786178)
,p_page_template_id=>wwv_flow_api.id(18048003506547786177)
,p_name=>'Header Bar'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18048003869866786178)
,p_page_template_id=>wwv_flow_api.id(18048003506547786177)
,p_name=>'Footer Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18048004319929786181)
,p_theme_id=>51
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18048006706238786193)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18048010927658786198)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048004491109786181)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048004596131786184)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048004638158786185)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048004710820786185)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048004868191786185)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048004974459786185)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048005004840786185)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048005159873786186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048005277537786186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048005371954786186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048005400179786186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048005561373786186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048005635386786186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18048005791306786186)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18048005922419786188)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18048006023281786190)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18048006136861786190)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18048006299014786191)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18048006318897786191)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18048005827827786187)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18048006441055786191)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18048006580514786192)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18048006687611786192)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(18048011331662786209)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(18048011297104786199)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(18048011802269786223)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(18048003506547786177)
,p_default_dialog_template=>wwv_flow_api.id(18048003485924786172)
,p_error_template=>wwv_flow_api.id(18048003506547786177)
,p_printer_friendly_template=>wwv_flow_api.id(18048003506547786177)
,p_login_template=>wwv_flow_api.id(18048003506547786177)
,p_default_button_template=>wwv_flow_api.id(18048010927658786198)
,p_default_region_template=>wwv_flow_api.id(18048005561373786186)
,p_default_chart_template=>wwv_flow_api.id(18048005561373786186)
,p_default_form_template=>wwv_flow_api.id(18048005561373786186)
,p_default_reportr_template=>wwv_flow_api.id(18048005791306786186)
,p_default_tabform_template=>wwv_flow_api.id(18048005561373786186)
,p_default_wizard_template=>wwv_flow_api.id(18048005561373786186)
,p_default_irr_template=>wwv_flow_api.id(18048005561373786186)
,p_default_report_template=>wwv_flow_api.id(18048005827827786187)
,p_default_label_template=>wwv_flow_api.id(18048006580514786192)
,p_default_calendar_template=>wwv_flow_api.id(18048011297104786199)
,p_default_list_template=>wwv_flow_api.id(18048006136861786190)
,p_default_nav_list_template=>wwv_flow_api.id(18048006023281786190)
,p_default_top_nav_list_temp=>wwv_flow_api.id(18048006023281786190)
,p_default_side_nav_list_temp=>wwv_flow_api.id(18048006318897786191)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(18048004491109786181)
,p_default_dialogr_template=>wwv_flow_api.id(18048005561373786186)
,p_default_option_label=>wwv_flow_api.id(18048006580514786192)
,p_default_header_template=>wwv_flow_api.id(18048005277537786186)
,p_default_footer_template=>wwv_flow_api.id(18048005004840786185)
,p_default_required_label=>wwv_flow_api.id(18048006687611786192)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(18048011486532786218)
,p_theme_id=>51
,p_name=>'Blue'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(18048011569677786218)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(18048011663999786218)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(18048011781831786218)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(18048003926500786179)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(18048006805148786195)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(18048007332678786196)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048004044239786180)
,p_theme_id=>51
,p_name=>'OVERLAY'
...
,p_group_id=>wwv_flow_api.id(18048003926500786179)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048004186762786181)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048004254991786181)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048006932397786195)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
,p_display_name=>'Action'
,p_display_sequence=>100
,p_button_template_id=>wwv_flow_api.id(18048006706238786193)
,p_css_classes=>'ui-icon-action'
,p_group_id=>wwv_flow_api.id(18048006805148786195)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048007093389786195)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048007117698786196)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048007290084786196)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048007470169786196)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
...
,p_group_id=>wwv_flow_api.id(18048007332678786196)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048007572515786196)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048007648252786196)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048007751809786196)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048007829339786196)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048007955252786196)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048008090836786196)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048008170157786196)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048008201321786196)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048008353643786196)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048008448501786196)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048008536866786196)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048008650844786197)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048008762237786197)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048008827203786197)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048008950747786197)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048009006836786197)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048009194195786197)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048009287050786197)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048009333346786197)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048009449838786197)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048009575018786197)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048009640158786197)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048009725009786197)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048009890873786197)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048009977817786197)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048010065052786197)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
,p_display_name=>'Right'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048010139877786198)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048010296600786198)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048010392675786198)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048010424108786198)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048010597198786198)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048010609147786198)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048010736031786198)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048010820763786198)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048011021594786199)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(18048010927658786198)
,p_css_classes=>'ui-btn-inline'
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18048011103090786199)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(18048012173319786234)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(18048011929725786227)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(18048003311158786171)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(18048006318897786191)
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(18048011929725786227)
...
,p_last_updated_by=>'NATAHLIEBEAVERS@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20151124032451'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18048012583476786236)
,p_plug_name=>'Header'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048005277537786186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18048012888669786237)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048005004840786185)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18048012774357786237)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(18048012583476786236)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18048012607332786237)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18048012967475786237)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(18048012607332786237)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18048012967475786237)
,p_event_id=>wwv_flow_api.id(18048012967475786237)
,p_event_result=>'TRUE'
...
,p_last_updated_by=>'NATAHLIEBEAVERS@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20151123232831'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18050715922381827811)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048005561373786186)
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(18048003311158786171)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(18048006136861786190)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'NATAHLIEBEAVERS@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20151124030707'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18048435639986819170)
,p_plug_name=>'doREST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048005561373786186)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18048453918314819193)
,p_plug_name=>'Results'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048005791306786186)
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18050716453439827816)
,p_name=>'CLOB001'
,p_data_type=>'CLOB001'
,p_is_visible=>true
,p_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18048436072225819177)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18048435639986819170)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(18048436400579819178)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18048437277470819181)
,p_name=>'P2_DB'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(18048435639986819170)
,p_prompt=>'Db'
...
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(18048006580514786192)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18048448024183819184)
,p_name=>'P2_USER'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(18048435639986819170)
,p_item_default=>'C##cs347_nmb642 '
,p_prompt=>'User'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18048448888977819185)
,p_name=>'P2_PASS'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(18048435639986819170)
,p_item_default=>'orcl_nmb642 '
,p_prompt=>'Pass'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18048449671872819186)
,p_name=>'P2_MODE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(18048435639986819170)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18048450489203819187)
,p_name=>'P2_MODEL'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(18048435639986819170)
,p_item_default=>'F8'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18048451260956819189)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18048452084493819191)
,p_name=>'P2_RETURNFOR'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(18048435639986819170)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18048452818751819191)
,p_name=>'P2_QUERY'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(18048435639986819170)
,p_item_default=>'"MATCH (r:restaurant)-[:food]->(f:food) RETURN r, f.calories, f.meal_served, f.fat_content, f.sugar_content, f.name"'
,p_prompt=>'Query'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18048436809382819179)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Web Service Request'
,p_process_sql_clob=>'18048065744331626927:18048065917260626930'
,p_attribute_01=>wwv_flow_api.id(18048065917260626930)
...
wwv_flow_api.create_page(
 p_id=>3
,p_user_interface_id=>wwv_flow_api.id(18048011929725786227)
,p_name=>'Find a Restaurant'
,p_page_mode=>'NORMAL'
,p_step_title=>'Find a Restaurant'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(18058480208539515666)
,p_name=>'Restaurants'
,p_template=>wwv_flow_api.id(18048004710820786185)
,p_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
,p_ajax_enabled=>'Y'
,p_query_row_template=>wwv_flow_api.id(18048005827827786187)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18369544687146640029)
,p_query_column_id=>1
,p_column_alias=>'NULL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18323874931652295750)
,p_name=>'BIG_BITE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(18058480208539515666)
,p_prompt=>'Big Bite'
,p_pre_element_text=>'<a href="https://bigbiterestaurant.com/">'
,p_post_element_text=>'</a>'
,p_source=>'Big Bite Homepage'
,p_source_type=>'STATIC'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18344293492342316201)
,p_name=>'AUSTINS_PIZZA'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(18058480208539515666)
,p_prompt=>'Austin''s Pizza'
,p_pre_element_text=>'<a href="http://www.austinspizza.com/">'
,p_post_element_text=>'</a>'
,p_source=>'Austin''s Pizza Homepage'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(18048006580514786192)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18344293594802316202)
,p_name=>'LA_TRAVIATA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(18058480208539515666)
,p_prompt=>'La Traviata'
,p_pre_element_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<a href="http://latraviatatx.com/',
'">'))
,p_post_element_text=>'</a>'
,p_source=>'La Traviata Homepage'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(18048006580514786192)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18344293616809316203)
,p_name=>'QDOBA'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(18058480208539515666)
,p_prompt=>'Qdoba'
,p_pre_element_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<a href="https://www.qdoba.com/">',
''))
,p_post_element_text=>'</a>'
,p_source=>'Qdoba Homepage'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18344293706175316204)
,p_name=>'TEJIS'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(18058480208539515666)
,p_prompt=>'Teji''s'
,p_pre_element_text=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<a href="http://tejifoods.com/tejis2014/">',
''))
,p_post_element_text=>'</a>'
,p_source=>'Teji''s Homepage'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_begin_on_new_line=>'N'
,p_begin_on_new_field=>'N'
...
wwv_flow_api.create_page(
 p_id=>9
,p_user_interface_id=>wwv_flow_api.id(18048011929725786227)
,p_name=>'Get Directions'
,p_page_mode=>'NORMAL'
,p_step_title=>'Get Directions'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'NATAHLIEBEAVERS@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20151124063245'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18333766348566931804)
,p_plug_name=>'Directions'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048004710820786185)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select',
'jt2.name	name, jt3.address	address',
'from	apex_collections	t,',
'json_table(t.clob001,	''$.NAME[*]''	COLUMNS	rid	for	ordinality,	name	varchar2(20)	path	''$'')	jt2,',
'json_table(t.clob001,	''$.ADDRESS[*]''	COLUMNS	rid	for	ordinality,	address	varchar2(20)	path	''$'')	jt3',
'where	t.collection_name	=	''P2_DOREST_RESULTS'' and',
'jt2.rid = jt3.rid'))
,p_plug_source_type=>'NATIVE_JQM_COLUMN_TOGGLE'
,p_plug_query_headings_type=>'NO_HEADINGS'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'STRIPE:STROKE'
);
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369542575938640008)
,p_name=>'NAME'
,p_data_type=>'NAME'
,p_is_visible=>true
,p_display_sequence=>10
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369542647018640009)
,p_name=>'ADDRESS'
,p_data_type=>'ADDRESS'
,p_is_visible=>true
,p_display_sequence=>20
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18344296009937316227)
,p_name=>'AUSTINS_PIZZA_MAP'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18333766348566931804)
,p_prompt=>'Austin''s Pizza Map'
,p_pre_element_text=>'<a href="https://www.google.com/maps/place/124+Guadalupe+St,+Austin,+TX+78701/@30.2645955,-97.7501054,17z/data=!3m1!4b1!4m2!3m1!1s0x8644b50f5a33fadd:0x6fba30aa90254dd4">'
,p_post_element_text=>'</a>'
,p_source=>'Get Directions to Austin''s Pizza'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(18048006580514786192)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18344296187718316228)
,p_name=>'BIG_BITE_MAPS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(18333766348566931804)
,p_prompt=>'Big Bite Address'
,p_pre_element_text=>'<a href="https://www.google.com/maps/place/121+Guadalupe+St,+Austin,+TX+78701/@30.2645623,-97.7501118,17z/data=!3m1!4b1!4m2!3m1!1s0x8644b50f5a33fadd:0x5ae13e85f9d9a49e">'
,p_post_element_text=>'</a>'
,p_source=>'Get Directions to Big Bite'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(18048006580514786192)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18344296273215316229)
,p_name=>'LA_TRAVIATA_MAP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(18333766348566931804)
,p_prompt=>'La Traviata Map'
,p_pre_element_text=>'<a href="https://www.google.com/maps/place/Avenue+A,+Austin,+TX+78751/@30.3093022,-97.7349382,17z/data=!3m1!4b1!4m2!3m1!1s0x8644ca7afc9fc9d9:0x676f2b9d0f1b0a40">'
,p_post_element_text=>'</a>'
,p_source=>'Get Directions to La Traviata'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_new_grid=>true
,p_field_template=>wwv_flow_api.id(18048006580514786192)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18344296351345316230)
,p_name=>'QDOBA_MAPS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(18333766348566931804)
,p_prompt=>'Qdoba Map'
,p_pre_element_text=>'<a href="https://www.google.com/maps/place/122+Guadalupe+St,+Austin,+TX+78701/@30.2645789,-97.7501059,17z/data=!3m1!4b1!4m2!3m1!1s0x8644b50f5a33fadd:0x561093de5f569d02">'
,p_post_element_text=>'</a>'
,p_source=>'Get Directions to Qdoba'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_begin_on_new_line=>'N'
,p_begin_on_new_field=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18344296466208316231)
,p_name=>'TEJIS_MAP'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(18333766348566931804)
,p_prompt=>'Teji''s Map'
,p_pre_element_text=>'<a href="https://www.google.com/maps/place/120+Guadalupe+St,+Austin,+TX+78701/@30.2645623,-97.7501118,17z/data=!3m1!4b1!4m2!3m1!1s0x8644b50f5a33fadd:0xc92dbacaa340d5e5">'
,p_post_element_text=>'</a>'
,p_source=>'Get Directions to Teji''s'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_begin_on_new_line=>'N'
,p_begin_on_new_field=>'N'
...
wwv_flow_api.create_page(
 p_id=>10
,p_user_interface_id=>wwv_flow_api.id(18048011929725786227)
,p_name=>'Restaurant Details'
,p_page_mode=>'NORMAL'
,p_step_title=>'Restaurant Details'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'NATAHLIEBEAVERS@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20151124063731'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18323873686809295737)
,p_plug_name=>'Seating Chart'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048004710820786185)
...
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(18323873706273295738)
,p_default_chart_type=>'2DDoughnut'
,p_chart_title=>'Number of Seats'
,p_chart_rendering=>'FLASH_PREFERRED'
,p_display_attr=>':H:N:V:::Bottom::H:Y:Star7::N:N:::::::'
,p_dial_tick_attr=>':::::::::::'
,p_gantt_attr=>':::::::::::::::::::'
,p_pie_attr=>'Outside:::'
...
,p_values_font=>'Tahoma:10:#FFFFFF'
,p_hints_font=>'Tahoma:10:#F565F5'
,p_legend_font=>'Tahoma:10:#000000'
,p_chart_title_font=>'Tahoma:14:#FFFFFF'
,p_x_axis_title_font=>'::'
,p_y_axis_title_font=>'::'
,p_gauge_labels_font=>'::'
,p_use_chart_xml=>'N'
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(18323873864011295739)
,p_chart_id=>wwv_flow_api.id(18323873706273295738)
,p_series_seq=>10
,p_series_name=>'Number of Seats'
,p_series_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select',
'null link, jt2.name	name, jt3.number_of_seats	number_of_seats',
'from	apex_collections	t,',
'json_table(t.clob001,	''$.NAME[*]''	COLUMNS	rid	for	ordinality,	name	varchar2(20)	path	''$'')	jt2,',
'json_table(t.clob001,	''$.NUMBER_OF_SEATS[*]''	COLUMNS	rid	for	ordinality,	number_of_seats	number	path	''$'')	jt3',
'where	t.collection_name	=	''P2_DOREST_RESULTS'' and',
'jt2.rid = jt3.rid',
''))
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18335309241900027251)
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select',
'jt2.food_type	food_type, jt3.name	name',
'from	apex_collections	t,',
'json_table(t.clob001,	''$.FOOD_TYPE[*]''	COLUMNS	rid	for	ordinality,	food_type	varchar2(20)	path	''$'')	jt2,',
'json_table(t.clob001,	''$.NAME[*]''	COLUMNS	rid	for	ordinality,	name	varchar2(20)	path	''$'')	jt3',
'where	t.collection_name	=	''P2_DOREST_RESULTS'' and',
'jt2.rid = jt3.rid'))
,p_plug_source_type=>'NATIVE_JQM_COLUMN_TOGGLE'
,p_plug_query_headings_type=>'NO_HEADINGS'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369542760190640010)
,p_name=>'FOOD_TYPE'
,p_data_type=>'FOOD_TYPE'
,p_is_visible=>true
,p_display_sequence=>10
,p_heading=>'Food type'
,p_heading_alignment=>'CENTER'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369542830700640011)
,p_name=>'NAME'
,p_data_type=>'NAME'
,p_is_visible=>true
,p_display_sequence=>20
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18336452447769917396)
,p_plug_name=>'Meal Served'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048004710820786185)
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select ',
'jt1.X4_1    X4_1, jt2.X1_1	X1_1, jt3.name    name',
'from	apex_collections	t,',
'json_table(t.clob001,	''$.X4_1[*]''	COLUMNS	rid	for	ordinality,	X4_1	varchar2(20)	path	''$'')	jt1,',
'',
'json_table(t.clob001,	''$.X1_1[*]''	COLUMNS	rid	for	ordinality,	X1_1	varchar2(20)	path	''$'')	jt2,',
'',
'json_table(t.clob001,	''$.NAME[*]''	COLUMNS	rid	for	ordinality,	name	varchar2(20)	path	''$'')	jt3',
'',
'where	t.collection_name	=	''P2_DOREST_RESULTS'' and',
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369542932533640012)
,p_name=>'X4_1'
,p_data_type=>'X4_1'
,p_is_visible=>true
,p_display_sequence=>10
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369543085528640013)
,p_name=>'X1_1'
,p_data_type=>'X1_1'
,p_is_visible=>true
,p_display_sequence=>20
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369543179318640014)
,p_name=>'NAME'
,p_data_type=>'NAME'
,p_is_visible=>true
,p_display_sequence=>30
...
wwv_flow_api.create_page(
 p_id=>11
,p_user_interface_id=>wwv_flow_api.id(18048011929725786227)
,p_name=>'Nutrition Facts'
,p_page_mode=>'NORMAL'
,p_step_title=>'Nutrition Facts'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'NATAHLIEBEAVERS@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20151124063640'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18350844006044750860)
,p_plug_name=>'Calories'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048004710820786185)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'/*select ',
'jt2.X0_1	X0_1, jt3.X4_1    X4_1',
'from	apex_collections	t,',
'json_table(t.clob001,	''$.X0_1[*]''	COLUMNS	rid	for	ordinality,	X0_1	varchar2(20)	path	''$'')	jt2,',
'json_table(t.clob001,	''$.X4_1[*]''	COLUMNS	rid	for	ordinality,	X4_1	varchar2(20)	path	''$'')	jt3',
'where	t.collection_name	=	''P2_DOREST_RESULTS'' and',
'jt2.rid = jt3.rid',
'*/',
'',
'select',
'jt2.X4_1	X4_1, jt3.X0_1	X0_1',
'from	apex_collections	t,',
'json_table(t.clob001,	''$.X4_1[*]''	COLUMNS	rid	for	ordinality,	X4_1	varchar2(20)	path	''$'')	jt2,',
'json_table(t.clob001,	''$.X0_1[*]''	COLUMNS	rid	for	ordinality,	X0_1	varchar2(20)	path	''$'')	jt3',
'where	t.collection_name	=	''P2_DOREST_RESULTS'' and',
'jt2.rid = jt3.rid'))
,p_plug_source_type=>'NATIVE_JQM_COLUMN_TOGGLE'
,p_plug_query_headings_type=>'NO_HEADINGS'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369543219305640015)
,p_name=>'X0_1'
,p_data_type=>'X0_1'
,p_is_visible=>true
,p_display_sequence=>10
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369543357319640016)
,p_name=>'X4_1'
,p_data_type=>'X4_1'
,p_is_visible=>true
,p_display_sequence=>20
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18351093062480770449)
,p_plug_name=>'Fat Content (in grams)'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048004710820786185)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
...
'--X2_1',
'select ',
'jt2.X2_1	X2_1, jt3.X4_1    X4_1',
'from	apex_collections	t,',
'json_table(t.clob001,	''$.X2_1[*]''	COLUMNS	rid	for	ordinality,	X2_1	varchar2(20)	path	''$'')	jt2,',
'json_table(t.clob001,	''$.X4_1[*]''	COLUMNS	rid	for	ordinality,	X4_1	varchar2(20)	path	''$'')	jt3',
'where	t.collection_name	=	''P2_DOREST_RESULTS'' and',
'jt2.rid = jt3.rid'))
,p_plug_source_type=>'NATIVE_JQM_COLUMN_TOGGLE'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369543414903640017)
,p_name=>'X2_1'
,p_data_type=>'X2_1'
,p_is_visible=>true
,p_display_sequence=>10
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369543524478640018)
,p_name=>'X4_1'
,p_data_type=>'X4_1'
,p_is_visible=>true
,p_display_sequence=>20
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18351292677420797419)
,p_plug_name=>'Sugar Content (in grams)'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18048004710820786185)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'N'
...
'--X2_1',
'select ',
'jt2.X3_1	X3_1, jt3.X4_1    X4_1',
'from	apex_collections	t,',
'json_table(t.clob001,	''$.X3_1[*]''	COLUMNS	rid	for	ordinality,	X3_1	varchar2(20)	path	''$'')	jt2,',
'json_table(t.clob001,	''$.X4_1[*]''	COLUMNS	rid	for	ordinality,	X4_1	varchar2(20)	path	''$'')	jt3',
'where	t.collection_name	=	''P2_DOREST_RESULTS'' and',
'jt2.rid = jt3.rid'))
,p_plug_source_type=>'NATIVE_JQM_COLUMN_TOGGLE'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369543613539640019)
,p_name=>'X3_1'
,p_data_type=>'X3_1'
,p_is_visible=>true
,p_display_sequence=>10
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18369543768271640020)
,p_name=>'X4_1'
,p_data_type=>'X4_1'
,p_is_visible=>true
,p_display_sequence=>20
...
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(18048065744331626927)
,p_name=>'RestfulReL'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(18048065917260626930)
,p_ws_id=>wwv_flow_api.id(18048065744331626927)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18048066252876626934)
,p_ws_opers_id=>wwv_flow_api.id(18048065917260626930)
,p_name=>'query'
,p_input_or_output=>'I'
,p_parm_type=>'string'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18048453207188819192)
,p_parameter_id=>wwv_flow_api.id(18048066252876626934)
,p_process_id=>wwv_flow_api.id(18048436809382819179)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_QUERY'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18048066527873626936)
,p_ws_opers_id=>wwv_flow_api.id(18048065917260626930)
,p_name=>'json'
,p_input_or_output=>'O'
,p_parm_type=>'json'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18048273727666799534)
,p_ws_opers_id=>wwv_flow_api.id(18048065917260626930)
,p_name=>'DB'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18048437659627819183)
,p_parameter_id=>wwv_flow_api.id(18048273727666799534)
,p_process_id=>wwv_flow_api.id(18048436809382819179)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_DB'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18048274030207799535)
,p_ws_opers_id=>wwv_flow_api.id(18048065917260626930)
,p_name=>'USER'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18048448412566819185)
,p_parameter_id=>wwv_flow_api.id(18048274030207799535)
,p_process_id=>wwv_flow_api.id(18048436809382819179)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_USER'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18048274307007799535)
,p_ws_opers_id=>wwv_flow_api.id(18048065917260626930)
,p_name=>'PASS'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18048449238906819186)
,p_parameter_id=>wwv_flow_api.id(18048274307007799535)
,p_process_id=>wwv_flow_api.id(18048436809382819179)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_PASS'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18048274617709799535)
,p_ws_opers_id=>wwv_flow_api.id(18048065917260626930)
,p_name=>'MODE'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18048450085179819187)
,p_parameter_id=>wwv_flow_api.id(18048274617709799535)
,p_process_id=>wwv_flow_api.id(18048436809382819179)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_MODE'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18048274921645799536)
,p_ws_opers_id=>wwv_flow_api.id(18048065917260626930)
,p_name=>'MODEL'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18048450883862819188)
,p_parameter_id=>wwv_flow_api.id(18048274921645799536)
,p_process_id=>wwv_flow_api.id(18048436809382819179)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_MODEL'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18048275214894799536)
,p_ws_opers_id=>wwv_flow_api.id(18048065917260626930)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18048451679807819190)
,p_parameter_id=>wwv_flow_api.id(18048275214894799536)
,p_process_id=>wwv_flow_api.id(18048436809382819179)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_RETURNDIMENSIONS'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18048275564792799536)
,p_ws_opers_id=>wwv_flow_api.id(18048065917260626930)
,p_name=>'returnFor'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18048452436846819191)
,p_parameter_id=>wwv_flow_api.id(18048275564792799536)
,p_process_id=>wwv_flow_api.id(18048436809382819179)
,p_map_type=>'ITEM'
